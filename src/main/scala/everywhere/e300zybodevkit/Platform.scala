...
//-------------------------------------------------------------------------
// E300ZyboDevKitPlatformIO
//-------------------------------------------------------------------------

class E300ZyboDevKitPlatformIO(implicit val p: Parameters) extends Bundle {
  val pins = new Bundle {
...
//-------------------------------------------------------------------------
// E300ZyboDevKitPlatform
//-------------------------------------------------------------------------

class E300ZyboDevKitPlatform(implicit val p: Parameters) extends Module {
  val sys = Module(LazyModule(new E300ZyboDevKitSystem).module)
  val io = new E300ZyboDevKitPlatformIO
