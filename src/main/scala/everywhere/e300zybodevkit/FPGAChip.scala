...
import sifive.fpgashells.shell.xilinx.zyboshell.{ZyboShell}
import sifive.fpgashells.ip.xilinx.{IBUFG, IOBUF, PULLUP, PowerOnResetFPGAOnly}

//-------------------------------------------------------------------------
// E300ZyboDevKitFPGAChip
//-------------------------------------------------------------------------

class E300ZyboDevKitFPGAChip(implicit override val p: Parameters) extends ZyboShell {
  ...
  withClockAndReset(clock_32MHz, ck_rst) {
    val dut = Module(new E300ZyboDevKitPlatform)
    ...
    IOBUF(jd_2, dut.io.pins.jtag.TCK)
    PULLUP(jd_2)
    ...
    // Mirror outputs of GPIOs with PWM peripherals to RGB LEDs on Zybo
